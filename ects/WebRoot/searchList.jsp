       ...
       <!-- 主体内容 -->
        ...
        <div class="right_content">
            		...
            		<div class="prod_img">
               		...
               		<div class="prod_det_box">
                    	...
                    	<div class="box_center">
                    		...
                    		<%--<a href="${pageContext.request.contextPath}/addToCart.do?productId=${product.id}" class="more"><img src="images/cart1.gif" alt="add to cart" title="" border="0" /></a>
			...
			<div class="pagination">
            	...
            	<br/><br/>
                <a href="${pageContext.request.contextPath}/search.do?destId=1${condition}">首页</a>
                <c:if test="${pageController.hasPrevious}">
            		<a href="${pageContext.request.contextPath}/search.do?destId=${pageController.currentPage-1}${condition}">上一页</a>
            	</c:if>
            		<span class="current">
						<select id="pageSelector" style="font-size:12px;padding-top:3px;"
							onchange="location='${pageContext.request.contextPath}/search.do?destId='+this.value+'${condition}'">
							<c:out value="${pageSelector}" escapeXml="false"></c:out>
						</select>
					</span>				
				<c:if test="${pageController.hasNext}">
            		<a href="${pageContext.request.contextPath}/search.do?destId=${pageController.currentPage+1}${condition}">下一页</a>
            	</c:if>
            	<a href="${pageContext.request.contextPath}/search.do?destId=${pageController.totalPages}${condition}">最后一页</a>
            </div>
