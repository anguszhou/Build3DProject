       ...
       <!-- 主体内容 -->
        ...
        <div class="right_content">
            ...
            <div class="pagination">
            	...
            	<br/><br/>
                <a href="${pageContext.request.contextPath}/typeList.do?destId=1&type=${type}">首页</a>
                <c:if test="${pageController.hasPrevious}">
            		<a href="${pageContext.request.contextPath}/typeList.do?destId=${pageController.currentPage-1}&type=${type}">上一页</a>
            	</c:if>
            		<span class="current">
						<select id="pageSelector" style="font-size:12px;padding-top:3px;"
							onchange="location='${pageContext.request.contextPath}/typeList.do?destId='+this.value+'&type=${type}'">
							<c:out value="${pageSelector}" escapeXml="false"></c:out>
						</select>
					</span>				
				<c:if test="${pageController.hasNext}">
            		<a href="${pageContext.request.contextPath}/typeList.do?destId=${pageController.currentPage+1}&type=${type}">下一页</a>
            	</c:if>
            	<a href="${pageContext.request.contextPath}/typeList.do?destId=${pageController.totalPages}&type=${type}">最后一页</a>
            </div> 
        	<div class="clear"></div>
        </div>
      <!-- 右侧栏 -->
