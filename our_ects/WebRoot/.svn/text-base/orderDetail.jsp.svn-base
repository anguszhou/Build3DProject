	        		...
	        		<div class="feat_prod_box_details">
	            		<table class="cart_table">
		                	...
		                	<c:forEach items="${order.orderlines}" var="orderLine" varStatus="varStatus">                
			            		<tr>
			                		<td>
			                			<a href="${pageContext.request.contextPath }/productDetail.do?productId=${orderLine.product.id}">
			                				<img src="images/${orderLine.product.images}" border="0" class="cart_thumb" width="119px"/>
			                			</a>
			                		</td>
