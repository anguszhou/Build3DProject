...
public class Product {
	...
	private String descriptions;//商品详细描述
	...
	public Product(int product_id, String name, double price, Date time,
			String descriptions, String image, ProductClass productClass,
			Seller seller, Set propertys, Set comments, StarRating starRating)
	{
		super();
