					...
					<div class="feat_prod_box_details">
						...
						<div class="prod_img">
							...
							<a
								...
								<img src="images/${productDetail.image}" border="0" style="margin-left: 10px;"
						...
						<div class="prod_det_box" style="margin-right:1px;">
							...
							<%--<div class="prod_title">
								...
								<div class="">
								 		<c:forEach items="${productDetail.propertys}" var="property"  varStatus="varStatus">
											<tr>
						...
						<div class="tabs-container">
							...
							<div style="display: block;" class="tab" id="tab1">
								<p class="more_details">
									<span>${productDetail.descriptions}</span>
								</p>
