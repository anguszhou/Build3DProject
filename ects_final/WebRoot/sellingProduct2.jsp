...
<div id="wrap">
 ...
 --%></font>
                    		...
                    		<div class="clear"></div>
                    		<div><button
											onclick="Alert('确认删除?',null,null,'确认删除?',function(){location='${pageContext.request.contextPath}/deleteProduct.do?productId=${product.product_id}';},null);">
											删除
							</button>
							<button
											onclick="Alert('添加新属性?',null,null,'添加新属性?',function(){location='${pageContext.request.contextPath}/addProperty3.do?productId=${product.product_id}';},null);">
											添加属性
							</button>
							</div>  
            ...
            <div class="pagination">
                ...
                <c:if test="${pageController.hasPrevious}">
            		<a href="${pageContext.request.contextPath}/sellerProductList.do?destId=${pageController.currentPage-1}">上一页</a>
            	</c:if>
            		<span class="current">
				...
				<c:if test="${pageController.hasNext}">
            		<a href="${pageContext.request.contextPath}/sellerProductList.do?destId=${pageController.currentPage+1}">下一页</a>
            	</c:if>
            	<a href="${pageContext.request.contextPath}/sellerProductList.do?destId=${pageController.totalPages}">最后一页</a>
            </div> 
        	<div class="clear"></div>
        </div>
      <!-- 右侧栏 -->
