...
<body>	
    ...
    <div id="menu">
        ...
        <c:if test="${user != null}">
        	<li class="right"><a href="${pageContext.request.contextPath}/showSeller.do">账户管理</a></li>
        	<li class="right"><a href="${pageContext.request.contextPath}/sellerProductList.do">出售</a></li>
        	<li class="right"><a href="${pageContext.request.contextPath}/addSellerProduct.jsp">新增</a></li>
        ...
        <c:if test="${user == null}">
        	...
        	<li class="right"><a href="${pageContext.request.contextPath}/loginadmin.jsp">后台管理</a></li>
        </c:if>
