						...
						<div  class="contact_form"  style="margin-left:150px;width:65%;">
							...
							<form style="padding-left:5%;" action="${pageContext.request.contextPath}/modify.do" method="post">
								<table>
									...
									<tr>
										<td >联系地址：</td>
										<td><input type="text"  size="35" name="address" value="${user.contcatInfo.address }"/></td>
									</tr>
									...
									<tr>
										<td >Email地址：</td>
										<td ><input type="text" size="32" name="email" value="${user.contcatInfo.email}"/><font color="red">*请输入有效的邮件地址</font>
										</td>
									</tr>
								</table>
								<div class="form_row"/>
