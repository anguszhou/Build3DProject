					...
					<div class="feat_prod_box_details">
						...
						<div class="contact_form" style="margin-left: 150px; width: 65%;">
							...
							<form style="padding-left: 5%;"
								action="${pageContext.request.contextPath}/registSeller.do"
								method="post">
								<table>
									<tr>
										<td>
									...
									<tr>
										...
										<td>
											<input type="text" size="35" name="realName" />
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<input type="text" size="35" name="shopName" />
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<input type="text" size="35" maxlength="100" name="shopDescriptions" />
											<font color="red">*请输入100个字符以内</font>
										</td>
									</tr>									
								</table>
