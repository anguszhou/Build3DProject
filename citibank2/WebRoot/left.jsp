	   ...
	   <div class="left">
	    ...
	    <ul>
					...
					<li><a href="introduction.jsp">产品介绍</a></li>
						<c:if test="${tag == 0 && user.usertype.id == 3}">
							<li><a href="#">后台管理</a></li>
						</c:if>
						<c:if test="${tag == 1}">
							<li><a href="#">企业用户</a></li>
						</c:if>
						<c:if test="${tag == 0 && (user.usertype.id == 1||user.usertype.id == 2)}">
							<li><a href="#">银行用户</a></li>
						</c:if>
					<li><a href="#">帮助</a></li>
   ...
   document.write("</TR>");
		...
		<form action="" method="post">
			...
			<label><font size="3">用户名:</font></label>
				<tr align="center"><font size="3">${user.username}</font></tr>
			<br /><br />
			<label><font size="3">登录身份:</font></label>
			<c:if test="${tag == 0}">			
				<tr align="center"><font size="3">${user.usertype.name}</font></tr>
			</c:if>
			<c:if test="${tag == 1}">			
				<tr align="center"><font size="3">企业用户</font></tr>
			</c:if>
			<br />
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/logout.do"  align="right">退出  </a>
		</form>
