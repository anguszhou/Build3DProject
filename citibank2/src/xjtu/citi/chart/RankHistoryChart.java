...
* @return 生成图片的文件名 
*/ 
public String getRankChart(HttpSession session, PrintWriter pw , int id) 
{ 
...
//标题
TextTitle title = new TextTitle("企业历史总排名曲线", font_title); 
...
TimeSeries s1 = new TimeSeries("企业历史总排名曲线",Day.class);//创建时间数据源，每一个//TimeSeries在图上是一条曲线 
...
for (Iterator iterator = list.iterator(); iterator.hasNext();)
{
	...
	s1.add(new Day(sme.getTime()),sme.getRank());
}
