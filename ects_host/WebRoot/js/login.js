	...
	function login(form)
	{
		...
		var ajaxUrl = "/our_ects/login.AsynLogin?name="+form.name.value+"&password="+form.password.value;
		...
		{			
			...
			{
				document.getElementById("ects_message").innerText="用户名或密码错误，请重新登录！";
			}
		});
	...
	function testUserName(caller,messageId)
	{
		...
		var ajaxUrl = "/our_ects/testUserName.AsynLogin?name="+caller.value;
