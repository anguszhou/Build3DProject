		...
		<div id="wrap">
			...
			<div class="center_content">
				...
				<div class="pagination">
            		...
            		<br/><br/>
               	 	<a href="${pageContext.request.contextPath}/promotedProduct.do?destId=1">首页</a>
	                <c:if test="${pageController.hasPrevious}">
	            		<a href="${pageContext.request.contextPath}/promotedProduct.do?destId=${pageController.currentPage-1}">上一页</a>
	            	</c:if>
	            		<span class="current">
							<select id="pageSelector" style="font-size:12px;padding-top:3px;"
								onchange="location='${pageContext.request.contextPath}/promotedProduct.do?destId='+this.value">
								<c:out value="${pageSelector}" escapeXml="false"></c:out>
							</select>
						</span>				
					<c:if test="${pageController.hasNext}">
	            		<a href="${pageContext.request.contextPath}/promotedProduct.do?destId=${pageController.currentPage+1}">下一页</a>
	            	</c:if>
	            	<a href="${pageContext.request.contextPath}/promotedProduct.do?destId=${pageController.totalPages}">最后一页</a>
	            </div> 
				<div class="clear"></div>
				</div>
				<!--end of left content-->
