	        		...
	        		<div class="feat_prod_box_details">
	            		...
	            		<c:forEach items="${cart.items}" var="orderLine" varStatus="varStatus">                
		            		<tr>
		                		...
		                		<td><a href="${pageContext.request.contextPath}/productDetail.do?productId=${orderLine.value.product.product_id}"><img src="images/${orderLine.value.product.name}" alt="" title="" border="0" class="cart_thumb" width="119px"/></a></td>
