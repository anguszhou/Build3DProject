		...
		<div id="wrap">
			...
			<div class="center_content">
				...
				<div class="right_content">        	
           	 		<div class="title">
           	 			<span class="title_icon"><img src="images/bullet1.gif" alt="" title="" />特价商品<br /></span>
           	 		</div>
				...
				<div class="pagination">
            		...
            		<br/><br/>
               	 	<a href="${pageContext.request.contextPath}/special.do?destId=1">首页</a>
	                <c:if test="${pageController.hasPrevious}">
	            		<a href="${pageContext.request.contextPath}/special.do?destId=${pageController.currentPage-1}">上一页</a>
	            	</c:if>
	            		<span class="current">
					...
					<c:if test="${pageController.hasNext}">
	            		<a href="${pageContext.request.contextPath}/special.do?destId=${pageController.currentPage+1}">下一页</a>
	            	</c:if>
	            	<a href="${pageContext.request.contextPath}/special.do?destId=${pageController.totalPages}">最后一页</a>
	            </div> 
				<div class="clear"></div>
				</div>
				<!--end of left content-->
